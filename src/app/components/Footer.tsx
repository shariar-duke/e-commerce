    ...
    <footer className='bg-[#F9FAFB] pt-8 pb-6 mt-7'>
      <div className='max-w-screen-3xl mx-auto px-10'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-6 mt-6'>
          ...
          <div>
            <p className='text-lg font-semibold mb-2'>Policies</p>
            <div className='space-y-1 text-gray-600'>
          ...
          <div>
            <p className='text-lg font-semibold mb-2'>Newsletter</p>
            <p className='text-gray-600 mb-2'>Subscribe for updates on deals & offers</p>
            <div className='relative'>
              <input
                type='text'
                placeholder='Your email address'
                className='w-full border border-gray-300 rounded-lg py-2 pl-10 pr-3 focus:outline-none focus:border-blue-500 transition'
              />
              <Search
